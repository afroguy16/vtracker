...
<section id="admin-detail-page">
    <div class="admin-detail-inner">
        <div class="row">
            <div class="col-sm-2">
                <div class="admin-left adminDetail">
                    ...
                    <nav class="navbar remove-bottom-margin">
                        <ul class="nav navbar-link navbar-right">
                            <li><a href="{{url('/admindetails')}}">Admin Detail</a></li>
                            <li><a href="{{url('/adminhistory')}}">Admin History</a></li>
                            <li><a href="{{url('/editadmin')}}">Edit Profile</a></li>
                            <li><a href="{{url('/register')}}">Add Admin</a></li>
                            <li><a href="#">Sessions</a></li>
                            <li><a href="#">Visitor's Trend</a></li>
